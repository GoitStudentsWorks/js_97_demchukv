import{i as r}from"./assets/scroll-up-c5900c93.js";import"./assets/vendor-e8675f53.js";const t={favoritesContent:document.querySelector(".favorites-card-content")},a="favorites";let o=null;const i=` <div class="favorites-content">
...
<p class="favorites-text">
  ...
  for easier access in the future.
    ...
    `,o=document.querySelectorAll(".favorites-delete")}else t.favoritesContent.innerHTML=i}catch(s){console.log(s)}o&&o.forEach(s=>{s.addEventListener("click",e=>{let l=localStorage.getItem(a),p=JSON.parse(l);const n=e.target.closest(".favorites-item"),d=n.dataset.id;localStorage.setItem(a,JSON.stringify(p.filter(({_id:f})=>f!==d)));const c=document.querySelector(".favorites-group");c.removeChild(n),c.children.length===0&&(t.favoritesContent.innerHTML=i)})});function v(s){return s.map(e=>`
